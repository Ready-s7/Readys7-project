...
import { Search, Loader2, Briefcase, Tag, Wrench } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {isLoading ? (
          ...
          <Tabs defaultValue="projects" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-10 bg-white p-1 rounded-2xl shadow-sm border h-14">
